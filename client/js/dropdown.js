...
//			var child, children = document.getElementsByClassName("category-field"), i
//			for (i = 0; i < children.length; i += 1) {
//				child = children[i]
//				util.f.addStyle(child, "Opacity", 1)
//			}
//			children = document.getElementsByClassName("sudo-select")
//			for (i = 0; i < children.length; i += 1) {
//				child = children[i]
...
//	},
//	select: {
//		blur: function (category_field) {
//			category_field.classList.remove("focused")
//			var child, children = category_field.childNodes, i, ii, nested_child, nested_children
//			for (i = 0; i < children.length; i += 1) {
//				child = children[i]
...
//						if (!category_field.dataset.value) {
//							util.f.addStyle(child, ["FontSize", "Top"], ["16px", "32px"])
//						}
//					} else if (child.classList.contains("sudo-select")) {
...
//			}
//		},
//		focus: function (category_field) {
//			category_field.classList.add("focused")
//			var bool = false, child, children = category_field.childNodes, i, ii, iii, nested_child, nested_children, nested_nested_child, nested_nested_children, size = 0
//			for (i = 0; i < children.length; i += 1) {
//				child = children[i]
...
//				child.addEventListener("click", form.f.select.toggle)
//				category_field.insertBefore(child, children[0])
//			}
//			for (i = 0; i < children.length; i += 1) {
//				child = children[i]
//				if (util.f.isElem(child) && child.classList.contains("sudo-select")) {
//					nested_children = child.childNodes
//					for (ii = 0; ii < nested_children.length; ii += 1) {
//						nested_child = nested_children[ii]
...
//				child = children[i]
//				if (util.f.isElem(child)) {
//					if (child.classList.contains("sudo-select")) {
//						nested_children = child.childNodes
//						for (ii = 0; ii < nested_children.length; ii += 1) {
//							nested_child = nested_children[ii]
...
//                        util.f.addStyle(child, ["Color", "Margin-top"], ["#38cc70", "-16px"]);
//				   }
//			   }
//			}
//		},
...
//			switch (true) {
//				case (child.classList.contains("sudo-select")):
//				case (child.classList.contains("deselect")):
//					parent = child.parentNode
//					break
//				case (child.classList.contains("category-options")):
//					parent = child.parentNode.parentNode
//					break
//				case (child.classList.contains("category-option")):
